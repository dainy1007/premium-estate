...
export function getVerifiedSaleInfo(property: Property): VerifiedSaleInfo | null {
  ...
  // 현풍읍 중리 462-4: 동일 주소지 네이버 매물 및 건물정보 교차확인 반영.
  // 매매가 6억8,000 / 대지 261.9㎡ / 연면적 392.59㎡ / 지상 3층 / 북향
  // 사용승인일 2015.04.24 / 주차 4대 / 건축물 용도 단독주택(상가주택 형태)
