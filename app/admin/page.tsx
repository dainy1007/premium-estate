  ...
  return <main className="min-h-screen bg-[#F8F9FB] px-4 py-8 text-[#0A2342]">
    <div className="mx-auto max-w-7xl">
      ...
      <section className="mt-6 rounded-[32px] bg-white p-5 shadow-sm md:p-8">
        ...
        {loading ? <p className="py-16 text-center">매물을 불러오는 중입니다...</p> : <div className="mt-6 overflow-x-auto"><table className="w-full min-w-[1180px]"><thead className="bg-[#F8F9FB] lg:sticky lg:top-[236px] lg:z-20 lg:shadow-sm"><tr>{["번호","매물명","유형","지역·가격","상태","빠른 관리","상세 관리"].map(v=><th key={v} className="px-4 py-4 text-left">{v}</th>)}</tr></thead><tbody>
