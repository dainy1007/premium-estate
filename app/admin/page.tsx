...
export default function AdminPage() {
  ...
  async function handleDuplicate(property: AdminProperty) {
    ...
    try {
      ...
      if (!response.ok || !result.ok || !result.property_id) {
