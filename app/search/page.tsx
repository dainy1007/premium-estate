...
function formatPublicAddress(value?: string | null) {
  ...
  return tokens.filter((token) => !/^\d+(?:-\d+)?$/.test(token)).slice(0, 3).join(" ") || "위치 문의";
}
