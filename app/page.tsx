...
export default function Home() {
  ...
  const quickLinks = [
    { label: "원룸/투룸", sub: "깔끔한 원룸부터 투룸까지", type: "소형주택", image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=900&q=88" },
    { label: "다가구/주택", sub: "단독·다가구·전원주택", type: "주택", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=900&q=88" },
    { label: "오피스텔", sub: "주거와 업무를 한 번에", type: "오피스텔", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=900&q=88" },
    { label: "상가(사무실)", sub: "상가·사무실·점포", type: "상가", image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=900&q=88" },
    { label: "아파트", sub: "다양한 아파트 매물", type: "아파트", image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=900&q=88" },
    { label: "창고/공장/토지", sub: "창고·공장·토지 매물", type: "창고·공장", image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=900&q=88" },
  ];
  const regionLinks = [
